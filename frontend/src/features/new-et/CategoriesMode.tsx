        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-ink-muted">
              Create, edit, nest, and delete categories. Deleting never removes transactions.
            </p>
          </div>
        </div>
        <button
                ...
                <tr key={c.id}>
                  {isEditing && editDraft ? (
                    ...
                    <>
                      ...
                      <td className="px-4 py-2 text-ink-muted">{c.necessity}</td>
                      <td className="px-4 py-2 text-ink-muted">{c.life_domain}</td>
