...
import type { CleanupPreview, CleanupResult, Health, SheetsStatus } from "../api/types";
      ...
      <section className="card space-y-3 p-5">
        ...
        {sheets ? (
          <>
            ...
            <a className="btn-ghost inline-flex text-sm" href="/api/setup" target="_blank" rel="noreferrer">
